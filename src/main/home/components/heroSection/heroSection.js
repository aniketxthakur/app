    ...
    return (
        <div id='home' className=' md:pt-36 pt-16 text-white bg-no-repeat bg-auto md:bg-contain' style={{ backgroundImage: `url(${Vector})`}} >
            <div className='text-center px-3 py-10 md:w-[800px] mx-auto grid gap-5'>
                ...
                <DefaultButton name='Contact Us' class='transition duration-300 ease-in-out hover:scale-110 bg-white text-blue-800 text-xl font-semibold px-14 py-5 md:mt-4' />
            </div>
            {/* Card */}
            <HeroSectionCard />
        </div>
